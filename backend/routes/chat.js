 ...
 *   get:
 *     tags: [Event Chat]
 *     summary: GET /api/chat/my-events
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
...
/**
 * @swagger
 * /api/chat/{eventId}/messages:
 *   get:
 *     tags: [Event Chat]
 *     summary: GET /api/chat/{eventId}/messages
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/chat/{eventId}/read:
 *   post:
 *     tags: [Event Chat]
 *     summary: POST /api/chat/{eventId}/read
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/chat/{eventId}/canAccess:
 *   get:
 *     tags: [Event Chat]
 *     summary: GET /api/chat/{eventId}/canAccess
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/chat/{eventId}/status:
 *   get:
 *     tags: [Event Chat]
 *     summary: GET /api/chat/{eventId}/status
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/chat/{eventId}/lock:
 *   post:
 *     tags: [Event Chat]
 *     summary: POST /api/chat/{eventId}/lock
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/chat/{eventId}/unlock:
 *   post:
 *     tags: [Event Chat]
 *     summary: POST /api/chat/{eventId}/unlock
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
