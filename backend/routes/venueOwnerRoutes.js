...
/**
 * @swagger
 * /api/venue-owner/venues:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/venues
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}:
 *   patch:
 *     tags: [Venue Owner]
 *     summary: PATCH /api/venue-owner/venues/{id}
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/booking-requests:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/booking-requests
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/booking-requests/{id}/accept:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/booking-requests/{id}/accept
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/booking-requests/{id}/decline:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/booking-requests/{id}/decline
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/bookings:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/bookings
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/bookings/history:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/bookings/history
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/bookings/{id}/cancel:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/bookings/{id}/cancel
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/bookings/{id}/details:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/bookings/{id}/details
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/bookings-table:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues/{id}/bookings-table
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/timeline:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues/{id}/timeline
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/availability:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues/{id}/availability
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/wallet:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/wallet
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/wallet/withdraw:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/wallet/withdraw
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
/**
 * @swagger
 * /api/venue-owner/analytics:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/analytics
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/reviews:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/reviews
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/availability-blocks:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues/{id}/availability-blocks
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/venues/{id}/availability-blocks
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/availability-blocks/{blockId}/toggle:
 *   patch:
 *     tags: [Venue Owner]
 *     summary: PATCH /api/venue-owner/venues/{id}/availability-blocks/{blockId}/toggle
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/availability-blocks/{blockId}:
 *   delete:
 *     tags: [Venue Owner]
 *     summary: DELETE /api/venue-owner/venues/{id}/availability-blocks/{blockId}
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/venues/{id}/events/{eventId}/seats:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/venues/{id}/events/{eventId}/seats
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/book-seat:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/book-seat
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
/**
 * @swagger
 * /api/venue-owner/bookings/{id}/event-team:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/bookings/{id}/event-team
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/notifications/eligible-hosts/{venueId}:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/notifications/eligible-hosts/{venueId}
 *     parameters:
 *       - in: path
 *         name: venueId
 *         required: true
...
/**
 * @swagger
 * /api/venue-owner/notifications/send:
 *   post:
 *     tags: [Venue Owner]
 *     summary: POST /api/venue-owner/notifications/send
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
/**
 * @swagger
 * /api/venue-owner/notifications/sent-log:
 *   get:
 *     tags: [Venue Owner]
 *     summary: GET /api/venue-owner/notifications/sent-log
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
