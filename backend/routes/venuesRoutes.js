 ...
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/featured
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
 ...
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/suggestions
 *     responses:
 *       200:
 *         description: Successful response
 *         content:
...
/**
 * @swagger
 * /api/venues/owner/{ownerId}/profile:
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/owner/{ownerId}/profile
 *     parameters:
 *       - in: path
 *         name: ownerId
 *         required: true
 ...
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/wishlist
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
...
/**
 * @swagger
 * /api/venues/my-bookings:
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/my-bookings
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
...
/**
 * @swagger
 * /api/venues/{id}/wishlist:
 *   post:
 *     tags: [Venues]
 *     summary: POST /api/venues/{id}/wishlist
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/{id}/reviews
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   post:
 *     tags: [Venues]
 *     summary: POST /api/venues/{id}/reviews
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/venues/{id}/check-availability:
 *   get:
 *     tags: [Venues]
 *     summary: GET /api/venues/{id}/check-availability
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
