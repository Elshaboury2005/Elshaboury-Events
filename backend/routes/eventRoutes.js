 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/my/events
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/seat-map
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/reviews
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/reviews
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/view
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/views
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/Events/{id}/revenue-trend:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/revenue-trend
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/post-event-summary:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/post-event-summary
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/post-event-report:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/post-event-report
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/vault
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/vault/transactions:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/vault/transactions
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/vault/withdraw:
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/vault/withdraw
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/cancellation-summary:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/cancellation-summary
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/cancel
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/select-venue:
 *   patch:
 *     tags: [Events]
 *     summary: PATCH /api/Events/{id}/select-venue
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/venue-details:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/venue-details
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/marketing/access:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/marketing/access
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/marketing/setup:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/marketing/setup
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   put:
 *     tags: [Events]
 *     summary: PUT /api/Events/{id}/marketing/setup
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/marketing/generate:
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/marketing/generate
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/waitlist
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/promo-codes
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/{id}/promo-codes
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/promo-codes/{promoId}/deactivate:
 *   patch:
 *     tags: [Events]
 *     summary: PATCH /api/Events/{id}/promo-codes/{promoId}/deactivate
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/promo-codes/{promoId}/activate:
 *   patch:
 *     tags: [Events]
 *     summary: PATCH /api/Events/{id}/promo-codes/{promoId}/activate
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/promo-codes/{promoId}:
 *   delete:
 *     tags: [Events]
 *     summary: DELETE /api/Events/{id}/promo-codes/{promoId}
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/Events/{id}/promo/validate:
 *   post:
 *     tags: [Events]
 *     summary: POST /api/Events/{id}/promo/validate
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
...
/**
 * @swagger
 * /api/Events/platform-fee-settings:
 *   get:
 *     tags: [Events]
 *     summary: GET /api/Events/platform-fee-settings
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
