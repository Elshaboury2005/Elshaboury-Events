...
exports.getMyNotebooks = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Failed to retrieve notebooks' });
  }
};
...
exports.getNotebookById = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Failed to retrieve notebook' });
  }
};
...
exports.createNotebook = async (req, res) => {
  try {
    ...
    res.status(201).json({ success: true, notebook, message: 'Notebook created successfully' });
  } catch (error) {
...
exports.useNotebook = async (req, res) => {
  try {
    ...
    res.json({ success: true, message: 'Notebook usage updated' });
  } catch (error) {
    console.error('Use notebook error:', error);
    res.status(500).json({ success: false, message: 'Failed to update notebook usage' });
  }
};
